                                        ...
                                        found.push(
                                             {
                                                  ...
                                                  "category_slug": tipuesearch.pages[i].category_slug,
                                                  "date": tipuesearch.pages[i].date,
                                                  "Modified": tipuesearch.pages[i].Modified,
                         ...
                         if (c != 0) {
                              ...
                              for (var i = 0; i < found.length; i++) {
                                   if (l_o >= start && l_o < set.show + start) {
                                        // 結果表示html
                                        out += '<article class="post-list">';
                                        out += '<header><div class="post-thumb">'
                                        ...
                                        if (found[i].img) {
                                             if (set.imageZoom) {
                                                  ...
                                                  out += '<a href="' + found[i].url + '"' + tipue_search_w + '><img src="' + found[i].img + '" alt="' + found[i].title + '"></a>';
                                             }
                                        }
                                        ...
                                        out += '<h3><a href="' + found[i].url + '"' + tipue_search_w + '>' + found[i].title + '</a></h3><span>';



                                        //Modifiedがなければdateを表示
                                        if (found[i].Modified == null) {
                                             out += '<time datetime="' + found[i].date + '">' + found[i].date + '</time> in';
                                        }
                                        else {
                                             out += '<time datetime="' + found[i].date + '"><i class="fas fa-sync-alt" aria-hidden="true"></i>' + found[i].date + '</time> in';
                                        }
                                        // 結果表示に`カテゴリ`を追加
                                        out += '<a href="' + found[i].category_slug + '">' + found[i].category + '</a>';
                                        // 結果表示にタグを追加
                                        out += '</span>< span class="tags" >#' + found[i].tags + '</span > ';
                                        ...
                                        if (found[i].desc) {
                                             ...
                                             out += '<div class="snippet"><a href="' + found[i].url + '"' + tipue_search_w + '>' + t_d + '</a></div>';
                              ...
                              if (c > set.show) {
                                   ...
                                   out += '<div id="tipue_search_foot"><ul id="pagination">';
                                   ...
                                   if (page <= 2) {
                                        ...
                                        for (var f = 0; f < p_b; f++) {
                                             if (f == page) {
                                                  out += '<li class="active" role="navigation">' + (f + 1) + '</li>';
                                             }
                                             else {
