                    ...
                    if (c != 0) {
                        ...
                        for (var i = 0; i < found.length; i++) {
                            if (l_o >= start && l_o < set.show + start) {
                                // 結果表示html
                                out += '<article class="tipue_search_result post-list">';
                                ...
                                if (found[i].img) {
                                    if (set.imageZoom) {
                                        ...
                                        out += '<a href="' + found[i].url + '"' + tipue_search_w + '><img class="tipue_search_img" src="' + found[i].img + '" alt="' + found[i].title + '"></a>';
                                    }
                                }
                                ...
                                out += '<h3 class="tipue_search_content_title"><a href="' + found[i].url + '"' + tipue_search_w + '>' + found[i].title + '</a></h3>';
                                ...
                                // 結果表示にタグを追加
                                out += '<span class="tags">#' + found[i].tags + '</span>';
